...
//zdrojovy kod pro DLL C# (neautorsky kod s vyjimkou pridaneho kodu pro rozsireni poctu radku, prevzato z https://www.hardworkingnerd.com/how-to-read-and-write-to-google-sheets-with-c/ (Ian Preston) )
namespace GoogleSheetsHelper
{
    public class GoogleSheetsHelper
    {
        ...
        public void AddCells(GoogleSheetParameters googleSheetParameters, List<GoogleSheetRow> rows)
        {
            ...
            //prida 6000 radku za defaultnich 1000 radku 
            ...
            //requests.Requests.Add(request1); // pridany kod  //6000 radku 
            requests.Requests.Add(request2);   // pridany kod  //nevim kolik radku           
